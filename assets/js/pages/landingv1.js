...
$(document).ready(function($){
    ...
    $(window).on('scroll', function () {    // this will work when your window scrolled.
        ...
        if(height  > 80) {
            $("img.light-logo").attr("src","assets/images/logos/econnect-logo.png");
        } else{
            $("img.light-logo").attr("src","assets/images/logos/econnect-w.png");
        }
    });
    ...
    if ($('.navbar-light').length) {
        $(window).on('scroll', function () {    // this will work when your window scrolled.
            var height = $(window).scrollTop();  //getting the scrolling height of window
            if(height  > 80) {
                $('#signup-btn').removeClass('light-btn').addClass('primary-btn');
            } else{
                $('#signup-btn').removeClass('primary-btn').addClass('light-btn');
            }
        }); 
    }
